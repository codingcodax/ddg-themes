...
const Slider = ({ name }: SliderProps) => {
  ...
  return (
    <figure className='group relative aspect-video overflow-clip bg-white'>
      ...
      />
      <button
        className='absolute top-1/2 left-2 -translate-y-1/2 rounded-lg bg-white/40 p-2 hover:bg-white/60 dark:bg-black/40 dark:hover:bg-black/60 sm:hidden sm:group-hover:inline-block'
      ...
      <button
        className='absolute top-1/2 right-2 -translate-y-1/2 rounded-lg bg-white/40 p-2 hover:bg-white/60 dark:bg-black/40 dark:hover:bg-black/60 sm:hidden sm:group-hover:inline-block'
